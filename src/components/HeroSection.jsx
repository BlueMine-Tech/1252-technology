    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 pt-20 lg:pt-24">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-1/3 right-10 opacity-10">
          <svg width="200" height="200" viewBox="0 0 200 200" className="animate-spin-very-slow">
            <polygon points="100,20 170,60 170,140 100,180 30,140 30,60" fill="none" stroke="currentColor" strokeWidth="2" className="text-cyan-400"/>
            <polygon points="100,40 150,70 150,130 100,160 50,130 50,70" fill="none" stroke="currentColor" strokeWidth="1.5" className="text-blue-400"/>
          </svg>
        </div>
        ...
        <div className="absolute bottom-10 left-10 opacity-10">
          <svg width="150" height="150" viewBox="0 0 150 150" className="animate-pulse-slow">
            <path d="M20 20 L20 60 L60 60 L60 100 L100 100" fill="none" stroke="currentColor" strokeWidth="2" className="text-cyan-400" strokeDasharray="5,5"/>
            ...
            <path d="M130 20 L130 60 L90 60 L90 100 L50 100" fill="none" stroke="currentColor" strokeWidth="2" className="text-blue-400" strokeDasharray="5,5"/>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8 py-20">
        <div className="text-center">
          ...
          {/* Main Heading */}
          <h1
            className={`text-4xl md:text-5xl lg:text-6xl font-black mb-6 transition-all duration-1000 delay-200 ${
              isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'
            }`}
          >
            <span className="gold-border-text block text-white leading-tight mb-3">
              We Power Modern Businesses with
            </span>
            <span className="gold-border-text block text-white leading-tight mb-3">
              Trusted Enterprise IT Infrastructure
            </span>
          ...
          >
            {features.map((feature, index) => (
              ...
              >
                ...
                <span className="text-lg group-hover:scale-110 transition-transform duration-300">{feature.icon}</span>
