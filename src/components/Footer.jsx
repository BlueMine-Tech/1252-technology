            ...
            <ul className="space-y-2">
              <li>
                <a 
                  ...
                  className="text-sm text-slate-400 hover:text-cyan-400 transition-colors duration-300 inline-flex items-center gap-2"
                >
              ...
              <li className="inline-flex items-start gap-2 text-sm text-slate-400">
                ...
                <span className="text-left">60 Paya Lebar Road, #06-28,<br />Paya Lebar Square,<br />Singapore 409051</span>
              </li>
            </ul>
          </div>
        </div>
