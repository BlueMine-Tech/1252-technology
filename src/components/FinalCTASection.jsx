        ...
        <div className="grid md:grid-cols-3 gap-6 animate-fadeIn animation-delay-800">
          ...
          <div className="group relative bg-slate-800/40 backdrop-blur-sm p-6 rounded-xl border border-cyan-400/20 hover:border-cyan-400/50 transition-all duration-300 hover:bg-slate-800/60">
            ...
            <div className="relative z-10">
              ...
              <a href="mailto:max@1252.company" className="text-white hover:text-cyan-400 transition-colors duration-300 font-medium">
                max@1252.company
              </a>
            </div>
          </div>
          ...
          <div className="group relative bg-slate-800/40 backdrop-blur-sm p-6 rounded-xl border border-cyan-400/20 hover:border-cyan-400/50 transition-all duration-300 hover:bg-slate-800/60">
            ...
            <div className="relative z-10">
              ...
              <a href="tel:+6590026490" className="text-white hover:text-cyan-400 transition-colors duration-300 font-medium">
                +65 9002 6490
              </a>
            </div>
          </div>
