...
const IndustriesWeSupport = () => {
  ...
  const industries = [
    {
      name: 'Construction & Remote Sites',
      icon: (
    ...
    {
      name: 'Retail, F&B & Commercial Spaces',
      icon: (
        <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    {
      name: 'Utilities, Energy & Infrastructure',
      icon: (
        <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    {
      name: 'Smart Cities & IoT Deployments',
      icon: (
        <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    {
      name: 'Education & Training Institutions',
      icon: (
        <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  return (
    <section ref={sectionRef} className="py-20 lg:py-28 bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 relative overflow-hidden">
      ...
      <div className="absolute inset-0">
        {/* Gradient Orbs */}
        <div className="absolute top-20 right-0 w-96 h-96 bg-blue-600 rounded-full opacity-10 blur-3xl"></div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-base lg:text-lg text-slate-300 max-w-2xl mx-auto leading-relaxed">
            Delivering specialized hardware solutions across diverse sectors
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 lg:gap-6">
          {industries.map((industry, index) => (
            ...
            >
              {/* Card */}
              <div className="relative bg-slate-800/40 backdrop-blur-sm p-6 rounded-xl border border-cyan-400/20 hover:border-cyan-400/50 transition-all duration-300 hover:bg-slate-800/60 h-full flex flex-col items-center text-center">
                {/* Icon */}
                <div className="w-14 h-14 bg-gradient-to-br from-blue-600 to-cyan-500 rounded-lg flex items-center justify-center text-white mb-4 group-hover:scale-105 transition-transform duration-300">
                  {industry.icon}
                </div>

                {/* Name */}
                <h3 className="text-sm font-semibold text-white leading-tight group-hover:text-cyan-400 transition-colors duration-300">
                  {industry.name}
                </h3>
              </div>
            </div>
